...
<head>
  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-white shadow shadow-sm fixed-top fy-3">
    <div class="container">
      <a class="navbar-brand fw-bold" href="#"><span class="primary">INTI </span>SINERGI PRATAMA</a>
  ...
  <div class="teams bg-light py-5">
    <div class="container">
      ...
      <p class="text-center mt-4">Berikut adalah bebrapa testimonia kami dari beberapa client yang bergerak dalam berbagai bidang.</p>
      <div class="row mt-5">
        ...
        <div class="row">
          ...
          <div class="col-md-3">
            <h4 class="fw-bold">Join Our Newsletter</h2>
              <p>
                kirim masukan dan saran mealui email.
              </p>
    ...
    <div class="footer-down bg-darker text-white px-5 py-3">
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-md-5">
            <div class="copyright">
              &copy; Copyright <strong>IntiSinergiPratama</strong>. All Right Reserved
            </div>
            <div class="credits">
              Design by Team
            </div>
